...
class User_Detail extends Component {
  ...
  async componentDidMount()
  {
    ...
    console.log(devid);
      ...
      firebase.database().ref('Users_Login/').on('value', function (snapshot) {
...
if(this.state.password.length == 0)
{
  ...
  render() {
    ...
    <View style={styles.Submit2}><Text style={{fontSize:RFValue(25)}}>User Details</Text></View>
                ...
                <View style={styles.AgeContainer1}>
      ...
      />
        ...
        />
                ...
                <TouchableOpacity style={styles.Submit} onPress={this.handleLogin}>
                  <Text style={{fontSize:RFValue(16),color:'white',opacity:1}}>Submit</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.Submitskip} onPress={this.handleLogin}>
                  <Text style={{fontSize:RFValue(16),color:'white',opacity:1}}>Skip</Text>
                </TouchableOpacity>
